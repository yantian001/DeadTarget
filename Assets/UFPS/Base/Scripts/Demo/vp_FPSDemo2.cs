...
public class vp_FPSDemo2 : MonoBehaviour
{
	...
	private Vector3 m_ExplorePos = new Vector3(134.0023f, 102.64261f, -109.5f);
	...
	void DemoPhysics()
	{
		...
		if (m_Demo.ButtonSelection != m_ExamplesCurrentSel)
		{
			...
			m_Demo.Controller.PhysicsSlopeSlidiness = 0.1f;
			...
			switch (m_Demo.ButtonSelection)
			{
				...
				case 1:
					...
					break;
				case 2:
					m_Demo.Controller.MotorDamping = 1.0f;
					...
					vp_Timer.In(2.75f, delegate() { m_LookPoint = 4; m_Demo.Controller.MotorAcceleration = 0.0f; m_Demo.Controller.MotorDamping = 1.0f; m_Demo.LookDamping = 3.0f; }, m_ActionTimer3);
					vp_Timer.In(5.0f, delegate() { m_LookPoint = 5; m_RunForward = false; m_Demo.Controller.MotorAcceleration = 0.0f; m_Demo.Controller.MotorDamping = 1.0f; m_Demo.LookDamping = 1.0f; }, m_ActionTimer4);
					vp_Timer.In(9.0f, delegate() { m_LookPoint = 8; m_Demo.Controller.MotorAcceleration = 0.0f; m_Demo.Controller.MotorDamping = 1.0f; }, m_ActionTimer5);
					vp_Timer.In(11, delegate() { m_Demo.Controller.MotorAcceleration = 0.0f; m_Demo.Controller.MotorDamping = 1.0f; }, m_GoAgainTimer);
					break;
				case 4:
